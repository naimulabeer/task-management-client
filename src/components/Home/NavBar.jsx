...
function Navbar() {
  ...
  const links = (
    <nav id="sidebar" className="flex flex-col lg:flex-row lg:gap-10 gap-2">
      ...
      <NavLink to="/dashboard">Task Dashboard</NavLink>
      ...
      <div className="navbar bg-base-100 px-4 py-2">
        <div className="navbar-start">
          ...
          <Link to="/" className=" items-center flex">
            <img className="" src="/icon1.png" alt="logo" />
            <h1 className="hidden lg:block lg:text-sm font-bold">
              Task Trello
            </h1>
          </Link>
        </div>
        ...
        <div className="navbar-end">
          {user ? (
            ...
            <div className=" md:w-1/2 flex gap-5 items-center">
              <NavLink className="hover:text-blue-600" to="/signin">
                Log in
              </NavLink>
              <NavLink
